...
import ButtonArrowRight from "../Atoms/Buttons/ButtonArrowRight";
import ButtonArrowLeft from "../Atoms/Buttons/ButtonArrowLeft";
const Carousel = () => {
  const photos = [
    {
        ...
        <div className="carousel__content">
          <div className="content__left">
            <div className="slider">
              <ButtonArrowLeft handleMove={handleMove} />
              ...
              <ButtonArrowRight handleMove={handleMove} />
            </div>
          </div>
