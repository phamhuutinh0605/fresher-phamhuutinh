      ...
      <div className="product__detail">
        <div className="product__bg">
              ...
              <div className="detail__information">
                ...
                <div className="detail__quantity">
                  ...
                  <input
                    ...
                    value={quantity}
                    onChange={(e) =>
                      handleChangeQuantity(String(id), Number(e.target.value))
                    }
                  />
          ...
          <div className="product__review shopee__container">
            ...
            {handleFilterPost().length > 0 ? (
              handleFilterPost().map((item: IPostProp) => {
                return (
                  <div className="review__item" key={item.id.toString()}>
                    <div className="avatar">
                      <img src={item.avatar.toString()} alt="" />
                    </div>
                    <div className="review__infor">
                      ...
                      <div className="rating">
                        <span>
                          {Number(item.rating) > 4 ? 5 : item.rating}{" "}
                          <FontAwesomeIcon
                            icon={faStar}
                            style={{ color: "yellow" }}
                          />
